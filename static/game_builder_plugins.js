 ...
 * â€” $.ui 1.11.1
 * â€” $.ui datepicker ru localization
 * â€” $.ui touch punch 0.2.2
 * â€” calc 1.3
 * â€” select2 3.5.4
 * â€” Redactor 8.25 mod
 * â€” CodeMirror 5.9.1 + javascript and htmlmixed bundles
 * â€” JCrop 0.9
 * â€” loadImage 2.6.2
 * â€” $.list 0.4
 * â€” nicescroll 3.6.6
...
jQuery(function($) {
  $.datepicker.regional['ru'] = {
    ...
    monthNamesShort: ['ÑÐ½Ð²', 'Ñ„ÐµÐ²', 'Ð¼Ð°Ñ€', 'Ð°Ð¿Ñ€', 'Ð¼Ð°Ð¹', 'Ð¸ÑŽÐ½', 'Ð¸ÑŽÐ»', 'Ð°Ð²Ð³', 'ÑÐµÐ½', 'Ð¾ÐºÑ‚', 'Ð½Ð¾Ñ', 'Ð´ÐµÐº'],
  ...
  global.calc || (global.calc = calc = {
    gen: function(a, b) {
      ...
      var c, d, e = a.slice(0),
        f = e[0].length,
        g = e.length,
        h = e[0].slice(1).join("á´¥").split("á´¥"),
        i = e.map(function(a) {
          return a[0]
        }).slice(1).join("á´¥").split("á´¥");
      for (c = 1; g > c; c++)
...
/*Select2 3.5.4 Â© 2012 Igor Vaynberg*/
! function(a) {
...
! function(e) {
  ...
  function Ie(e, t, r) {
    var n = dt(e, t, "div", null, null, !e.options.singleCursorHeightPerLine),
      i = r.appendChild(Ui("div", "Â ", "CodeMirror-cursor"));
    if (i.style.left = n.left + "px", i.style.top = n.top + "px", i.style.height = Math.max(0, n.bottom - n.top) * e.options.cursorHeight + "px", n.other) {
      var o = r.appendChild(Ui("div", "Â ", "CodeMirror-cursor CodeMirror-secondarycursor"));
  ...
  function Dr(e, t) {
    if (!ki(e, "scrollCursorIntoView")) {
      ...
      if (t.top + n.top < 0 ? i = !0 : t.bottom + n.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null != i && !Mo) {
        var o = Ui("div", "â€‹", null, "position: absolute; top: " + (t.top - r.viewOffset - Ve(e.display)) + "px; height: " + (t.bottom - t.top + Xe(e) + r.barHeight) + "px; left: " + t.left + "px; width: 2px;");
  ...
  function Rn(e) {
    var t = Ui("span", "â€¢", "cm-invalidchar");
      ...
      if (a.test(t))
        for (var c = document.createDocumentFragment(), h = 0;;) {
          ...
          if (h += d + 1, "	" == f[0]) {
            ...
            var p = c.appendChild(Ui("span", "\r" == f[0] ? "â" : "â¤", "cm-invalidchar"));
  ...
  function Gn(e) {
    for (var t = " ", r = 0; r < e.length - 2; ++r) t += r % 2 ? " " : "Â ";
    return t += " "
  }
  ...
  function Zi(e) {
    ...
    var r = _l ? Ui("span", "â€‹") : Ui("span", "Â ", null, "display: inline-block; width: 1px; margin-right: -1px");
    return r.setAttribute("cm-text", ""), r
  }

  function Qi(e) {
    if (null != $l) return $l;
    var t = Ki(e, document.createTextNode("AØ®A")),
  ...
  re.prototype = zi({
    ...
    poll: function() {
      ...
      if (e.doc.sel == e.display.selForContextMenu) {
        ...
        if (8203 != i || r || (r = "â€‹"), 8666 == i) return this.reset(), this.cm.execCommand("undo")
      }
    ...
    onContextMenu: function(e) {
      ...
      function r() {
        if (n.contextMenuPending = !1, n.wrapper.style.position = "relative", l.style.cssText = c, bo && 9 > wo && o.scrollbars.setScrollTop(o.scroller.scrollTop = a), null != l.selectionStart) {
          ...
          var e = 0,
            r = function() {
              o.selForContextMenu == i.doc.sel && 0 == l.selectionStart && l.selectionEnd > 0 && "â€‹" == n.prevInput ? At(i, ul.selectAll)(i) : e++ < 10 ? o.detectingSelectAll = setTimeout(r, 500) : o.input.reset()
            };
  ...
  var Vl, Kl = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
    jl = e.isWordChar = function(e) {
      return /\w/.test(e) || e > "Â€" && (e.toUpperCase() != e.toLowerCase() || Kl.test(e))
    },
